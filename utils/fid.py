...
def calculate_fid(netG, dataloader, config, dims, use_z=False, use_msg=False, input_all=0, use_MN=False, netMN=None, use_hint=False):
...
def calculate_stat(dataloader):
    ...
    np.savez('fid_stats_color.npz', mu=mu, sigma=sigma)